...
<div class="container-fluid">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-2" style="margin-left: -31px; height: 87vh;">
                <?php
                    include("sidenav.php");
                        ...
                        <div class="col-md-6">
                            ...
                            <?php 
                                ...
                                if (mysqli_num_rows($res) < 1 ) {
                                    $output .= "<tr><td class='text-center' colspan='2'>No New Admin</td></tr>";
                                }
                        ...
                        <div class="col-md-6">
                            <?php
                                ...
                                if (isset($_POST['add'])) {
                                    ...
                                    include("../include/connection.php");
                                    $s = "select id from admin order by id desc";
